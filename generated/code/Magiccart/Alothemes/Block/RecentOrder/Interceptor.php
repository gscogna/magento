<?php
namespace Magiccart\Alothemes\Block\RecentOrder;

/**
 * Interceptor class for @see \Magiccart\Alothemes\Block\RecentOrder
 */
class Interceptor extends \Magiccart\Alothemes\Block\RecentOrder implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFrontendCfg');
        return $pluginInfo ? $this->___callPlugins('getFrontendCfg', func_get_args(), $pluginInfo) : parent::getFrontendCfg();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRecentOrder');
        return $pluginInfo ? $this->___callPlugins('getRecentOrder', func_get_args(), $pluginInfo) : parent::getRecentOrder();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getInfoPurchased');
        return $pluginInfo ? $this->___callPlugins('getInfoPurchased', func_get_args(), $pluginInfo) : parent::getInfoPurchased($product);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getInfoTime');
        return $pluginInfo ? $this->___callPlugins('getInfoTime', func_get_args(), $pluginInfo) : parent::getInfoTime($time);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'time_elapsed_string');
        return $pluginInfo ? $this->___callPlugins('time_elapsed_string', func_get_args(), $pluginInfo) : parent::time_elapsed_string($datetime, $full);
    }
